...
`)])])],-1);function Q(y,l,r,k,p,E){const i=B("render-demo-0"),m=B("demo");return N(),T("div",null,[S,F(m,{sourceCode:`<template>
	<div>
...
<\/script>
`},{highlight:x(()=>[I]),default:x(()=>[F(i)]),_:1})])}var z=P(O,[["render",Q]]);export{L as __pageData,z as default};
