...
`)])])],-1);function j(l,u,o,p,f,r){const g=b("render-demo-0"),d=b("demo");return U(),I("div",null,[$,q(d,{sourceCode:`<template>
...
`},{highlight:D(()=>[J]),default:D(()=>[q(g)]),_:1})])}var H=O(Q,[["render",j]]);export{G as __pageData,H as default};
