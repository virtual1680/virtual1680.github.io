...
`)])])],-1);function N(r,k,u,E,i,y){const m=h("render-demo-0"),g=h("demo");return S(),P("div",null,[L,A(g,{sourceCode:`<template>
	<div>
...
<\/script>
`},{highlight:w(()=>[H]),default:w(()=>[A(m)]),_:1})])}var $=x(j,[["render",N]]);export{X as __pageData,$ as default};
