import{_ as S,e as P,r as w,o as R,c as N,a as _,w as b,V as g,b as n,d as s,f as V}from"./app.2554123b.js";const U={name:"component-doc",components:{"render-demo-0":function(){const{createTextVNode:f,resolveComponent:l,withCtx:r,createVNode:k,createElementVNode:y,openBlock:B,createElementBlock:i}=g,d=f("\u81EA\u5B9A\u4E49");function A(e,C){const a=l("el-button"),m=l("qv-crud");return B(),i("div",null,[y("div",null,[k(m,{ref:"avueRef",data:e.config.data,option:e.option,onRefreshChange:e.refreshChange,onRowSave:e.rowSave,onRowUpdate:e.rowUpdate,onRowDel:e.rowDel},{menu:r(()=>[k(a,{link:""},{default:r(()=>[d]),_:1})]),_:1},8,["data","option","onRefreshChange","onRowSave","onRowUpdate","onRowDel"])])])}const{defineComponent:M}=g,{reactive:F,computed:v,ref:E,onMounted:D,nextTick:x}=g;return{render:A,...M({setup(e,{expose:C}){C();const a=E();D(()=>{P(()=>import("./app.2554123b.js").then(function(t){return t.m}),[]).then(t=>{a.value=t})});const m=E();let T=F({data:[{name:"\u5F20\u4E09",age:12,address:"\u7801\u4E91\u7684\u5730\u5740"},{name:"\u674E\u56DB",age:13,address:"\u7801\u4E91\u7684\u5730\u5740"}]});const q=v(()=>({height:200,viewBtn:!0,editBtn:!1,delBtn:!1,copyBtn:!0,column:[{label:"\u59D3\u540D",prop:"name"},{label:"\u5E74\u9F84",prop:"age"},{label:"\u5730\u5740",span:24,prop:"address",type:"textarea"}]})),h={ElementPlus:a,avueRef:m,config:T,option:q,refreshChange:()=>{const{ElMessage:t}=a.value;t.success("\u5237\u65B0\u56DE\u8C03")},rowSave:(t,p,u)=>{const{ElMessage:o}=a.value;t.id=new Date().getTime(),o.success("\u6A21\u62DF\u7F51\u7EDC\u8BF7\u6C42"),setTimeout(()=>{o.success("\u5173\u95ED\u6309\u94AE\u7B49\u5F85"),u()},1e3),setTimeout(()=>{o.success("\u65B0\u589E\u6570\u636E"+JSON.stringify(t)),p(t)},2e3)},rowDel:(t,p,u)=>{const{ElMessage:o,ElMessageBox:c}=a.value;c.confirm("\u6B64\u64CD\u4F5C\u5C06\u6C38\u4E45\u5220\u9664\u8BE5\u6587\u4EF6, \u662F\u5426\u7EE7\u7EED?","\u63D0\u793A",{confirmButtonText:"\u786E\u5B9A",cancelButtonText:"\u53D6\u6D88",type:"warning"}).then(()=>{u(t),o({type:"success",message:"\u5220\u9664\u6210\u529F!"})}).catch(()=>{})},rowUpdate:(t,p,u,o)=>{const{ElMessage:c}=a.value;c.success("\u6A21\u62DF\u7F51\u7EDC\u8BF7\u6C42"),setTimeout(()=>{c.success("\u5173\u95ED\u6309\u94AE\u7B49\u5F85"),o()},1e3),setTimeout(()=>{c.success("\u7F16\u8F91\u6570\u636E"+JSON.stringify(t)+"\u6570\u636E\u5E8F\u53F7"+p),u(t)},2e3)},reactive:F,computed:v,ref:E,onMounted:D,nextTick:x};return Object.defineProperty(h,"__isScriptSetup",{enumerable:!1,value:!0}),h}})}}()}},K='{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"components/crud/menu.md","lastUpdated":1659349838000}',O=n("blockquote",null,[n("p",null,"\u64CD\u4F5C\u680F\u914D\u7F6E")],-1),J=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
...
<\/script>
`},{highlight:b(()=>[J]),default:b(()=>[_(i)]),_:1}),$])}var Q=S(U,[["render",I]]);export{K as __pageData,Q as default};
