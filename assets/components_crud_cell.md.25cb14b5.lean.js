...
`)])])],-1);function U(d,m,g,y,f,E){const c=B("render-demo-0"),p=B("demo");return S(),R("div",null,[N,D(p,{sourceCode:`<template>
	<div>
...
<\/script>
`},{highlight:w(()=>[P]),default:w(()=>[D(c)]),_:1})])}var W=q(A,[["render",U]]);export{I as __pageData,W as default};
