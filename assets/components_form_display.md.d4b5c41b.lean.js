import{_ as C,c as E,a as h,w as r,V as i,b as n,r as w,o as b,d as s}from"./app.2e64142b.js";const F={name:"component-doc",components:{"render-demo-0":function(){const{toDisplayString:k,createTextVNode:m,resolveComponent:e,withCtx:d,createVNode:p,openBlock:f,createElementBlock:c}=i;function l(a,o){const t=e("el-button"),u=e("qv-form");return f(),c("div",null,[p(t,{onClick:a.change},{default:d(()=>[m(k(a.show?"\u9690\u85CF":"\u663E\u793A"),1)]),_:1},8,["onClick"]),p(u,{modelValue:a.config.form,"onUpdate:modelValue":o[0]||(o[0]=y=>a.config.form=y),option:a.config.option},null,8,["modelValue","option"])])}const{defineComponent:B}=i,{reactive:g,ref:_}=i;return{render:l,...B({setup(a,{expose:o}){o();const t=_(!1);let u=g({form:{},option:{column:[{label:"\u59D3\u540D",prop:"name",span:8},{label:"\u5BC6\u7801",prop:"password",type:"password",display:t}]}});const v={show:t,config:u,change:()=>{t.value=!t.value},reactive:g,ref:_};return Object.defineProperty(v,"__isScriptSetup",{enumerable:!1,value:!0}),v}})}}()}},S='{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"components/form/display.md","lastUpdated":1658992381000}',D=n("blockquote",null,[n("p",null,"\u9690\u85CF\u5B57\u6BB5")],-1),V=n("div",null,"\u5BF9\u5E94\u7684\u5B57\u6BB5\u914D\u7F6E display \u4E3A false \u5373\u53EF\u9690\u85CF",-1),q=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
...
`)])])],-1);function x(k,m,e,d,p,f){const c=w("render-demo-0"),l=w("demo");return b(),E("div",null,[D,h(l,{sourceCode:`<template>
...
<\/script>
`},{description:r(()=>[V]),highlight:r(()=>[q]),default:r(()=>[h(c)]),_:1})])}var $=C(F,[["render",x]]);export{S as __pageData,$ as default};
