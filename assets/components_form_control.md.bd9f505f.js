...
`)])])],-1);function R(u,k,i,m,y,f){const a=v("render-demo-0"),s=v("demo");return q(),C("div",null,[w,g(s,{sourceCode:`<template>
...
<\/script>
`},{description:r(()=>[E]),highlight:r(()=>[D]),default:r(()=>[g(a)]),_:1})])}var O=B(F,[["render",R]]);export{A as __pageData,O as default};
