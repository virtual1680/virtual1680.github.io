import{_ as R,e as h,r as g,o as P,c as V,a as y,w as E,V as l,b as n,d as s}from"./app.c086cfa3.js";const F={name:"component-doc",components:{"render-demo-0":function(){const{resolveComponent:r,createVNode:i,openBlock:k,createElementBlock:m}=l;function f(a,p){const o=r("qv-form");return k(),m("div",null,[i(o,{modelValue:a.config.form,"onUpdate:modelValue":p[0]||(p[0]=u=>a.config.form=u),ref:"qvFormRef",option:a.option,onSubmit:a.submit},null,8,["modelValue","option","onSubmit"])])}const{defineComponent:d}=l,{reactive:e,ref:t,onMounted:v}=l;return{render:f,...d({setup(a,{expose:p}){p();const o=t();v(()=>{h(()=>import("./app.c086cfa3.js").then(function(c){return c.m}),[]).then(c=>{o.value=c})});const u=t();let q=e({form:{}});const b=t({column:[{label:"\u59D3\u540D",prop:"name"}]}),_={ElementPlus:o,qvFormRef:u,config:q,option:b,submit:(c,D)=>{const{ElMessage:w}=o.value;w.success("2\u79D2\u540E\u5173\u95ED"),setTimeout(()=>{D()},2e3)},reactive:e,ref:t,onMounted:v};return Object.defineProperty(_,"__isScriptSetup",{enumerable:!1,value:!0}),_}})}}()}},N='{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"components/form/submit.md","lastUpdated":1659029761000}',M=n("blockquote",null,[n("p",null,"\u9632\u91CD\u63D0\u4EA4")],-1),C=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
