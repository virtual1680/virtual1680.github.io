import{_ as P,e as A,c as M,a as q,w as k,V as i,b as n,r as D,o as V,d as s}from"./app.c74dcb0e.js";const R={name:"component-doc",components:{"render-demo-0":function(){const{resolveComponent:d,createVNode:y,openBlock:m,createElementBlock:g}=i;function f(e,r){const p=d("qv-form");return m(),g("div",null,[y(p,{modelValue:e.config.form,"onUpdate:modelValue":r[0]||(r[0]=l=>e.config.form=l),ref:"qvFormRef",option:e.option,onSubmit:e.submit,onError:e.error},null,8,["modelValue","option","onSubmit","onError"])])}const{defineComponent:v}=i,{reactive:u,ref:c,computed:b,onMounted:E}=i;return{render:f,...v({setup(e,{expose:r}){r();const p=c();E(()=>{A(()=>import("./app.c74dcb0e.js").then(function(a){return a.au}),[]).then(a=>{p.value=a})});const l=c(),B=[{value:"zhinan",label:"\u6307\u5357",children:[{value:"shejiyuanze",label:"\u8BBE\u8BA1\u539F\u5219",children:[{value:"yizhi",label:"\u4E00\u81F4"},{value:"fankui",label:"\u53CD\u9988"}]}]}];let F=u({form:{name:"\u5F20\u4E09",password:""}});const w=(a,t,o)=>{t===""?o(new Error("\u8BF7\u8F93\u5165\u5BC6\u7801")):o()},_=(a,t,o)=>{t===""?o(new Error("\u8BF7\u518D\u6B21\u8F93\u5165\u5BC6\u7801")):t!==F.form.password?o(new Error("\u4E24\u6B21\u8F93\u5165\u5BC6\u7801\u4E0D\u4E00\u81F4!")):o()},h=b(()=>({column:[{label:"\u59D3\u540D",prop:"name",rules:[{required:!0,message:"\u8BF7\u8F93\u5165\u59D3\u540D",trigger:"blur"}]},{label:"\u6027\u522B",prop:"sex",rules:[{required:!0,message:"\u8BF7\u8F93\u5165\u6027\u522B",trigger:"blur"}]},{label:"\u591A\u9009",prop:"cascader",type:"cascader",dicData:B,rules:[{required:!0,type:"array",message:"\u8BF7\u9009\u62E9\u591A\u9009",trigger:"blur"}]},{label:"\u5BC6\u7801",prop:"password",type:"password",rules:[{validator:w,trigger:"blur"}]},{label:"\u786E\u8BA4\u5BC6\u7801",prop:"oldpassword",type:"password",rules:[{validator:_,trigger:"blur"}]}]})),C={ElementPlus:p,qvFormRef:l,dic:B,config:F,validatePass:w,validatePass2:_,option:h,submit:(a,t)=>{const{ElMessage:o}=p.value;o.success(JSON.stringify(a)),t()},error:a=>{const{ElMessage:t}=p.value;t.success("\u8BF7\u67E5\u770B\u63A7\u5236\u53F0"),console.log(a)},reactive:u,ref:c,computed:b,onMounted:E};return Object.defineProperty(C,"__isScriptSetup",{enumerable:!1,value:!0}),C}})}}()}},J='{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"components/form/data-validate.md","lastUpdated":1658992381000}',z=n("blockquote",null,[n("p",null,"\u6570\u636E\u9A8C\u8BC1")],-1),N=n("div",null,"\u914D\u7F6E\u9A8C\u8BC1\u5B57\u6BB5\u7684 rules \u7684\u6570\u636E\u5BF9\u8C61\u5373\u53EF\uFF0C\u5177\u4F53\u53C2\u8003 element \u4E2D form \u8868\u5355\u6821\u9A8C\u7684\u914D\u7F6E\u89C4\u5219\u5B98\u65B9\u89C4\u5219",-1),S=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
...
`)])])],-1);function x(d,y,m,g,f,v){const u=D("render-demo-0"),c=D("demo");return V(),M("div",null,[z,q(c,{sourceCode:`<template>
...
<\/script>
`},{description:k(()=>[N]),highlight:k(()=>[S]),default:k(()=>[q(u)]),_:1})])}var T=P(R,[["render",x]]);export{J as __pageData,T as default};
