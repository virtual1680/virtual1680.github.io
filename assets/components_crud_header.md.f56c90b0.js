...
`)])])],-1);function T(r,u,o,t,e,g){const k=w("render-demo-0"),i=w("demo");return P(),C("div",null,[L,f(i,{sourceCode:`<template>
	<div>
...
<\/script>
`},{highlight:A(()=>[S]),default:A(()=>[f(k)]),_:1})])}var j=q(V,[["render",T]]);export{H as __pageData,j as default};
