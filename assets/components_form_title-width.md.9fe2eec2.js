...
`)])])],-1);function h(c,l,r,i,k,m){const a=g("render-demo-0"),d=g("demo");return v(),_("div",null,[F,f(d,{sourceCode:`<template>
...
<\/script>
`},{description:p(()=>[D]),highlight:p(()=>[b]),default:p(()=>[f(a)]),_:1})])}var x=E(y,[["render",h]]);export{C as __pageData,x as default};
