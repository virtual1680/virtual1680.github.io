...
`)])])],-1);function q(u,k,i,m,y,d){const t=g("render-demo-0"),o=g("demo");return C(),D("div",null,[V,b(o,{sourceCode:`<template>
...
<\/script>
`},{description:l(()=>[w]),highlight:l(()=>[I]),default:l(()=>[b(t)]),_:1})])}var A=_(E,[["render",q]]);export{h as __pageData,A as default};
