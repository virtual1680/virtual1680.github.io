...
`)])])],-1);function W(r,k,c,u,f,b){const y=F("render-demo-0"),m=F("demo");return N(),L("div",null,[$,T,D(m,{sourceCode:`<template>
	<div>
...
<\/script>
`},{highlight:_(()=>[O]),default:_(()=>[D(y)]),_:1})])}var nn=P(V,[["render",W]]);export{Z as __pageData,nn as default};
