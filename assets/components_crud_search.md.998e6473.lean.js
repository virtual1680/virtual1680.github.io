import{_ as z,e as T,r as _,o as P,c as V,a as x,w,V as A,b as n,d as s}from"./app.c086cfa3.js";const N={name:"component-doc",components:{"render-demo-0":function(){const{createTextVNode:y,resolveComponent:c,withCtx:l,createVNode:o,createElementVNode:m,openBlock:C,createElementBlock:d}=A,g=y("\u6807\u9898");function S(a,t){const u=c("el-tag"),r=c("el-input"),h=c("qv-crud");return C(),d("div",null,[m("div",null,[o(h,{data:a.config.data,search:a.config.search,"onUpdate:search":t[2]||(t[2]=k=>a.config.search=k),option:a.option,onSearchChange:a.searchChange,onSearchReset:a.resetChange,onDateChange:a.dateChange},{search:l(({row:k,size:i})=>[m("div",null,[o(u,null,{default:l(()=>[g]),_:1}),o(r,{placeholder:"\u81EA\u5B9A\u4E49\u8F93\u5165\u6846",style:{width:"200px"},size:i.value,modelValue:a.config.search.name,"onUpdate:modelValue":t[0]||(t[0]=E=>a.config.search.name=E)},null,8,["size","modelValue"])])]),"sex-search":l(({row:k,size:i})=>[o(r,{placeholder:"\u81EA\u5B9A\u4E49\u8F93\u5165\u6846",size:i.value,modelValue:a.config.search.sex,"onUpdate:modelValue":t[1]||(t[1]=E=>a.config.search.sex=E)},null,8,["size","modelValue"])]),_:1},8,["data","search","option","onSearchChange","onSearchReset","onDateChange"])])])}const{defineComponent:q}=A,{reactive:D,computed:F,ref:B,onMounted:v,nextTick:M}=A;return{render:S,...q({setup(a,{expose:t}){t();const u=B();v(()=>{T(()=>import("./app.c086cfa3.js").then(function(e){return e.m}),[]).then(e=>{u.value=e})});let r=D({search:{name:"virtual1680"},data:[{name:"\u5F20\u4E09",sex:"\u7537",address:"\u7ED9\u4ED8\u5BF9\u4EF7\u963F\u5361\u4E3D"},{name:"\u674E\u56DB",sex:"\u5973",address:"\u53D1\u62C9\u8FDB\u6765"}]});const h=F(()=>({align:"center",menuAlign:"center",height:300,searchIndex:2,searchIcon:!0,dateBtn:!0,searchMenuSpan:8,searchBtnText:"\u67E5\u8BE2",searchBtnIcon:"Search",emptyBtnText:"\u91CD\u7F6E",emptyBtnIcon:"Close",searchLabelWidth:80,column:[{searchLabelWidth:55,label:"\u59D3\u540D",prop:"name",searchTip:"\u6211\u662F\u4E00\u4E2A\u9ED8\u8BA4\u63D0\u793A\u8BED",searchTipPlacement:"left",searchRules:[{required:!0,message:"\u8BF7\u8F93\u5165\u59D3\u540D",trigger:"blur"}],search:!0},{label:"\u6027\u522B",prop:"sex",search:!0,searchOrder:1},{label:"\u5730\u5740",prop:"address"},{label:"\u65E5\u671F",prop:"date",type:"datetime",searchSpan:12,searchRange:!0,search:!0}]})),f={ElementPlus:u,config:r,option:h,resetChange:e=>{const{ElMessage:p}=u.value;p.success("\u6E05\u7A7A\u56DE\u8C03")},searchChange:(e,p)=>{const{ElMessage:b}=u.value;b.success("2s\u540E\u5173\u95ED\u9501\u5B9A"),setTimeout(()=>{p(),b.success(JSON.stringify(e))},2e3)},dateChange:e=>{const{ElMessage:p}=u.value;p.success(JSON.stringify(e))},reactive:D,computed:F,ref:B,onMounted:v,nextTick:M};return Object.defineProperty(f,"__isScriptSetup",{enumerable:!1,value:!0}),f}})}}()}},J='{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"components/crud/search.md","lastUpdated":null}',I=n("blockquote",null,[n("p",null,"\u641C\u7D22")],-1),O=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
...
`)])])],-1);function R(y,c,l,o,m,C){const d=_("render-demo-0"),g=_("demo");return P(),V("div",null,[I,x(g,{sourceCode:`<template>
	<div>
		<qv-crud
			:data="config.data"
...
<\/script>
`},{highlight:w(()=>[O]),default:w(()=>[x(d)]),_:1})])}var U=z(N,[["render",R]]);export{J as __pageData,U as default};
