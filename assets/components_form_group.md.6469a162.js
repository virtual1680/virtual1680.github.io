...
`)])])],-1);function Q(v,i,E,e,p,c){const m=x("render-demo-0"),g=x("demo");return D(),O("div",null,[S,q(g,{sourceCode:`<template>
	<div>
...
<\/script>
`},{highlight:B(()=>[I]),default:B(()=>[q(m)]),_:1})])}var U=R(M,[["render",Q]]);export{J as __pageData,U as default};
