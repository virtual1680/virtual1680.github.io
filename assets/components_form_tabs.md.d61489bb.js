import{_ as P,b as R,r as F,o as T,c as N,d as x,w as B,V as g,e as n,f as s}from"./app.f52f2e58.js";const O={name:"component-doc",components:{"render-demo-0":function(){const{createTextVNode:y,resolveComponent:l,withCtx:r,createVNode:k,createElementVNode:p,openBlock:E,createElementBlock:i}=g,m=y("\u8F6C\u5316"),h=p("br",null,null,-1),q=p("br",null,null,-1),A=p("span",null,"\u81EA\u5B9A\u4E49\u8868\u5934",-1);function w(t,o){const f=l("el-button"),e=l("qv-form");return E(),i("div",null,[p("div",null,[k(f,{onClick:o[0]||(o[0]=u=>t.tabs=!t.tabs)},{default:r(()=>[m]),_:1}),h,q,k(e,{modelValue:t.config.form,"onUpdate:modelValue":o[1]||(o[1]=u=>t.config.form=u),onTabClick:t.handleTabClick,ref:"qvFormRef",option:t.option,onSubmit:t.submit},{"group1-header":r(()=>[A]),_:1},8,["modelValue","onTabClick","option","onSubmit"])])])}const{defineComponent:M}=g,{reactive:b,ref:c,onMounted:v}=g;return{render:w,...M({setup(t,{expose:o}){o();const f=c(),e=c();v(()=>{R(()=>import("./app.f52f2e58.js").then(function(a){return a.m}),[]).then(a=>{e.value=a})});let u=b({form:{text:"\u6587\u672C",text1:"\u6587\u672C1",text2:"\u6587\u672C2",text3:"\u6587\u672C3"}});const C=c(!0),D=c({tabs:C,tabsActive:"2",column:[{label:"\u5185\u5BB91",prop:"text1"}],group:[{icon:"Search",label:"\u5206\u7EC41",prop:"group1",column:[{label:"\u5185\u5BB91",prop:"text1"}]},{icon:"Info",label:"\u5206\u7EC42",prop:"group2",column:[{label:"\u9009\u9879\u53612",prop:"text2"},{label:"\u9009\u9879\u53613",prop:"text3"}]}]}),_={qvFormRef:f,ElementPlus:e,config:u,tabs:C,option:D,submit:(a,d)=>{const{ElMessage:V}=e.value;console.log("\u8FC7\u6EE4\u6570\u636E--",a),d(),V.success("\u5F53\u524D\u6570\u636E"+JSON.stringify(u.form))},handleTabClick:a=>{const{ElMessage:d}=e.value;d.success("\u5E8F\u53F7\u4E3A:"+a.index)},reactive:b,ref:c,onMounted:v};return Object.defineProperty(_,"__isScriptSetup",{enumerable:!1,value:!0}),_}})}}()}},L='{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"components/form/tabs.md","lastUpdated":1658992381000}',S=n("blockquote",null,[n("p",null,"\u9009\u9879\u5361\u5C55\u793A")],-1),I=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
