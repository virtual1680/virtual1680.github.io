...
`)])])],-1);function V(l,u,i,k,m,f){const s=y("render-demo-0"),a=y("demo");return x(),D("div",null,[B,v(a,{sourceCode:`<template>
...
<\/script>
`},{highlight:_(()=>[R]),default:_(()=>[v(s)]),_:1})])}var E=F(b,[["render",V]]);export{C as __pageData,E as default};
