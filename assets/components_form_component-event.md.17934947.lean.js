import{_ as h,e as P,c as q,a as F,w as k,V as i,b as n,r as b,o as D,d as s}from"./app.2e64142b.js";const w={name:"component-doc",components:{"render-demo-0":function(){const{resolveComponent:m,createVNode:g,openBlock:E,createElementBlock:v}=i;function f(p,l){const t=m("qv-form");return E(),v("div",null,[g(t,{ref:"form",modelValue:p.config.obj,"onUpdate:modelValue":l[0]||(l[0]=r=>p.config.obj=r),option:p.option},null,8,["modelValue","option"])])}const{defineComponent:d}=i,{computed:u,reactive:c,onMounted:B,ref:_}=i;return{render:f,...d({setup(p,{expose:l}){l();const t=_();B(()=>{P(()=>import("./app.2e64142b.js").then(function(a){return a.ao}),[]).then(a=>{t.value=a})});let r=c({obj:{}});const M=u(()=>({column:[{label:"\u7528\u6237\u540D",prop:"username",span:24,suffixIcon:"Plus",prefixIcon:"Search",maxlength:80,minlength:2,rules:[{required:!0,message:"\u8BF7\u8F93\u5165\u7528\u6237\u540D",trigger:"blur"}],click:({value:a,column:o})=>{const{ElMessage:e}=t.value;console.log(a,o),e.success("click")},change:({value:a,column:o})=>{const{ElMessage:e}=t.value;e.success("change\u4E8B\u4EF6\u67E5\u770B\u63A7\u5236\u53F0"),console.log("\u503C\u6539\u53D8",a,o)},focus:({value:a,column:o})=>{const{ElMessage:e}=t.value;e.success("focus\u4E8B\u4EF6\u67E5\u770B\u63A7\u5236\u53F0"),console.log("\u83B7\u53D6\u7126\u70B9",a,o)},blur:({value:a,column:o})=>{const{ElMessage:e}=t.value;e.success("blur\u4E8B\u4EF6\u67E5\u770B\u63A7\u5236\u53F0"),console.log("\u5931\u53BB\u7126\u70B9",a,o)},enter:({value:a,column:o})=>{const{ElMessage:e}=t.value;e.success("enter\u4E8B\u4EF6\u67E5\u770B\u63A7\u5236\u53F0"),console.log("\u56DE\u8F66\u4E8B\u4EF6",a,o)}}]})),y={ElementPlus:t,config:r,option:M,computed:u,reactive:c,onMounted:B,ref:_};return Object.defineProperty(y,"__isScriptSetup",{enumerable:!1,value:!0}),y}})}}()}},O='{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"components/form/component-event.md","lastUpdated":1659029761000}',V=n("blockquote",null,[n("p",null,"\u7EC4\u4EF6\u4E8B\u4EF6")],-1),x=n("div",null,"\u76EE\u524D\u7EC4\u4EF6\u6709 4 \u4E2A\u4E8B\u4EF6 change,click,focus,blur",-1),A=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
