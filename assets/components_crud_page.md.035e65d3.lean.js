...
`)])])],-1);function V(g,d,m,f,y,v){const u=b("render-demo-0"),p=b("demo");return B(),M("div",null,[L,S,P(p,{sourceCode:`<template>
	<div>
		<qv-crud
			:data="config.data"
			:option="option"
...
<\/script>
`},{highlight:x(()=>[T]),default:x(()=>[P(u)]),_:1})])}var j=D(q,[["render",V]]);export{$ as __pageData,j as default};
