...
`)])])],-1);function h(l,u,r,i,k,m){const a=_("render-demo-0"),d=_("demo");return D(),y("div",null,[B,g(d,{sourceCode:`<template>
...
<\/script>
`},{description:p(()=>[q]),highlight:p(()=>[V]),default:p(()=>[g(a)]),_:1})])}var C=v(b,[["render",h]]);export{F as __pageData,C as default};
