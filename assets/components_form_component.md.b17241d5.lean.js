...
`)])])],-1);function M(k,i,m,d,v,y){const e=f("render-demo-0"),o=f("demo");return L(),A("div",null,[P,h(o,{sourceCode:`<template>
...
<\/script>
`},{description:u(()=>[V]),highlight:u(()=>[q]),default:u(()=>[h(e)]),_:1})])}var I=C(w,[["render",M]]);export{Q as __pageData,I as default};
