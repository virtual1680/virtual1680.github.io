import{_ as F,r as v,o as D,c as x,a as _,w as y,V as r,b as n,d as t}from"./app.75dfeaf0.js";const b={name:"component-doc",components:{"render-demo-0":function(){const{resolveComponent:l,createVNode:u,openBlock:i,createElementBlock:k}=r;function m(o,e){const c=l("qv-form");return i(),k("div",null,[u(c,{modelValue:o.config.form,"onUpdate:modelValue":e[0]||(e[0]=p=>o.config.form=p),ref:"qvFormRef",option:o.option},null,8,["modelValue","option"])])}const{defineComponent:f}=r,{reactive:s,ref:a,computed:d}=r;return{render:m,...f({setup(o,{expose:e}){e();const c=a();let p=s({form:{text:""}});const q=d(()=>({column:[{label:"\u59D3\u540D",prop:"text",rules:[{required:!0,message:"\u8BF7\u8F93\u5165\u59D3\u540D",trigger:"blur"}]}]}));p.form.text="9090909";const g={qvFormRef:c,config:p,option:q,reactive:s,ref:a,computed:d};return Object.defineProperty(g,"__isScriptSetup",{enumerable:!1,value:!0}),g}})}}()}},C='{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"components/form/data-default.md","lastUpdated":null}',B=n("blockquote",null,[n("p",null,"\u6570\u636E\u9ED8\u8BA4\u503C")],-1),R=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
