...
`)])])],-1);function j(y,m,d,r,f,E){const g=D("render-demo-0"),v=D("demo");return $(),M("div",null,[I,T,U(v,{sourceCode:`<template>
	<div>
...
<\/script>
`},{highlight:x(()=>[Q]),default:x(()=>[U(g)]),_:1})])}var K=V(R,[["render",j]]);export{H as __pageData,K as default};
