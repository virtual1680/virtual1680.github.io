...
`)])])],-1);function h(c,u,k,i,y,m){const t=f("render-demo-0"),s=f("demo");return C(),B("div",null,[q,g(s,{sourceCode:`<template>
...
<\/script>
`},{highlight:v(()=>[D]),default:v(()=>[g(t)]),_:1})])}var R=F(_,[["render",h]]);export{x as __pageData,R as default};
